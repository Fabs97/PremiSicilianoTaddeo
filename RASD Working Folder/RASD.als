...
--All Violations are refered to only one Municipality
...
--All Tickets are refered to a Signalation of a valid Violation
fact TicketsForValidViolation{
    all t : Ticket | t.signalation.violation.isValid = True
}

--All Municipalities are refered to a Third Party or Violation
