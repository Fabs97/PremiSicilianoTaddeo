...
\begin{table}[H]
    \begin{tabular}{|l|l|}
    \hline
    Name & \begin{minipage}[t]{0.7\textwidth} \textbf{Report violation mistake\\}
    \end{minipage} \\ \hline  
     Actor & \begin{minipage}[t]{0.7\textwidth} User\\ \end{minipage} \\ \hline 
     Entry conditions & \begin{minipage}[t]{0.7\textwidth} The user has already
     logged in\\ \end{minipage} \\
    ...
    \begin{enumerate}
        \item The user opens the Menu
        \item The user selects the "My reports" button in the Menu
        \item The user is allowed to report mistake\\
    \end{enumerate}    
    \end{minipage} \\ \hline
     Exit conditions & \begin{minipage}[t]{0.7\textwidth} The mistake has been
     reported\\ \end{minipage} \\
     \hline
...
\end{table}
\newpage
\paragraph{Goals and requirements}\mbox{}\\
\begin{itemize}   
    \item $\langle$\textbf{G0}$\rangle$ SignUp to the system
    \begin{description}
    ...
    Use \end{description}
    \item $\langle$\textbf{G1}$\rangle$ SignIn to the system
    \begin{description}
    ...
    \item $\langle$\textbf{G2}$\rangle$ Signal a violation
    \begin{description}
    ...
    \end{description}
    \item $\langle$\textbf{G3}$\rangle$ Show Unsafe Areas
    \begin{description}
        ...
        unsafe areas 
    \end{description}    
    \item $\langle$\textbf{G4}$\rangle$ Manage Account
    \begin{description}
...
\begin{table}[H]
    \begin{tabular}{|l|l|}
    \hline
    Name & \begin{minipage}[t]{0.7\textwidth}\textbf{Visualize Statistics\\}
    \end{minipage} \\ \hline  
    Actor & \begin{minipage}[t]{0.7\textwidth} Authorithy user\\ \end{minipage} \\
    \hline 
    Entry conditions & \begin{minipage}[t]{0.7\textwidth} The authorithy user has
    ...
    \begin{enumerate}
        \item The authorithy user clicks on the menu icon
        \item The authorithy user clicks on "Statistics"
        \item The authorithy user is allowed to see the list of statistics
        \item The authorithy user click on "Open Details" of one particular statistic
        \item The authorithy user is allowed to see information about the particular
        statistic\\
    \end{enumerate}
    \end{minipage} \\ \hline
    Exit conditions & \begin{minipage}[t]{0.7\textwidth} The authorithy user can
    see information about statistics\\ \end{minipage} \\
    \hline
    Exceptions & \begin{minipage}[t]{0.7\textwidth}The authorithy user closes the
    website before the process has ended\\ \end{minipage} \\ \hline
    \end{tabular}
...
\newpage
\paragraph{Goals and requirements}
\begin{itemize}
\item $\langle$\textbf{G0}$\rangle$ SignUp to the system
\begin{description}
    \item $\langle$\textbf{R1}$\rangle$ the customer must not be already
...
\begin{description}
    ...
    password\\
\end{description}
\item $\langle$\textbf{G2}$\rangle$ Check Violations
\begin{description}
    ...
    the validity of the violation \end{description}
\item $\langle$\textbf{G3}$\rangle$ Show Unsafe Areas
\begin{description}
    \item $\langle$\textbf{R10}$\rangle$ the customer is allowed to filter the
    unsafe areas
...
\begin{description}
    ...
    his/her account
\end{description}  
\item $\langle$\textbf{G5}$\rangle$ Statistics analysis
\begin{description}
