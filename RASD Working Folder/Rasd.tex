...
some already proven servicese (like Google Maps API) for its critical tasks. The
system is composed of two different mobile applications: one for the citizens
that want to reports violations and one for the officers acting on the field.
