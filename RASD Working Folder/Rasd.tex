...
\begin{itemize}
    \item \textbf{Specification document:} "Mandatory Project Assignement AY 2019-2010"
    \item \textbf{Alloy doc:} \href{http://alloy.lcs.mit.edu/alloy/documentation/quickguide/seq.html}{\texttt{http://alloy.lcs.mit.edu/alloy/documentation/quickguide/seq.html}}
...
\begin{table}[H]
    ...
    Entry conditions &  \begin{minipage}[t]{0.7\textwidth}The user has downloaded the application on his/her
    device\\ \end{minipage}\\ \hline 
    Events flow & 
