...
\begin{description}
    \item $\langle$\textbf{R}$\rangle$ the user is shown the unsafe areas around him
    \item $\langle$\textbf{R}$\rangle$ the user is allowed to filter the unsafe areas
    \item $\langle$\textbf{R}$\rangle$ the user is allowed to search unsafe areas 
\end{description}    
...
\begin{description}
    ...
    \item $\langle$\textbf{R}$\rangle$ the user must be able to delete his/her account
\end{description}
...
\begin{description}
    \item $\langle$\textbf{R}$\rangle$ the third party must be able to check all the
    new and past violations
