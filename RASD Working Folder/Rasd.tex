...
From the first world in Figure 24 it can be noticed that every Police Officer has
...
From the second world in Figure 25 it can be noticed that there are two
...
From the third world in Figure 26 it can be noticed that every PoliceOfficer have
...
From the fourth world in Figure 27 it can be noticed that every signalation is
